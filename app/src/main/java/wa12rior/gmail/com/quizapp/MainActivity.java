...
//        I'm setting OnClickListener to my submit button
    ...
    private int getScore() {
        ...
        boolean thirdPartialFifthAnswer = ((CheckBox) findViewById(R.id.checkbox_fifth_A)).isChecked();
        boolean fourthPartialFifthAnswer = ((CheckBox) findViewById(R.id.checkbox_fifth_B)).isChecked();

        if (secondCorrectAnswer.equals("Yes")) {score++;}
        if (sixthCorrectAnswer.equals("Yes")) {score++;}

        if (firstPartialFifthAnswer && secondPartialFifthAnswer && !thirdPartialFifthAnswer && !fourthPartialFifthAnswer) {score++;}
        if (firstPartialThirdAnswer && secondPartialThirdAnswer && !thirdPartialThirdAnswer && !fourthPartialThirdAnswer) {score++;}

        if (firstCorrectAnswer) {score++;}
